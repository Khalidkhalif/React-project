...
const initState = {
    items: [
        ...
        { id: 10, name: 'Dronningen', price: 169, img: "./images/Dronningen.jpg", ingredients: 'ef, peppers, onions, mushrooms, squash'},
        ...
        { id: 18, name: 'Le vele del circeo', price: 179, img: "./images/Le vele del circeo.jpeg", ingredients: 'Pasta Italian cuisine Bolognese sauce Meatball Fra diavolo sauce, pasta, food, recipe, cuis'},
